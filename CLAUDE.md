...
חוויית חברים מלאה (קבוצות, פוש, אישור הצטרפות, טבלת ניקוד, תחבולות, קישור ישיר). פרומפט הגשה מלא: **`docs/COWORK_V130_SUBMIT.md`**. תג `ios-v12` + marker AAB נדחפו; ⚠️ **מצב v1.1.0/v1.2.0 בחנויות לא ידוע לקלוד** (לא אושר בסשן זה שהוגשו בפועל) — שלב 1 בפרומפט מנחה את cowork לברר עם רותם לפני ההגשה.
