...
- [ ] **משחק חדש: "לגלות את הפתגם שמסתתר בתמונה"** — תמונה מייצגת חזותית פתגם/ביטוי עברי (רבוס/חידה), והשחקנים מנחשים את הפתגם. לתכנן: מאגר פתגמים+תמונות (אולי יצירת תמונות ב-Gemini באדמין באותה מתכונת), לוגיקת ניחוש/רמזים, מסך משחק, ניקוד, ומולטיפלייר על אותה תשתית חדרים.
