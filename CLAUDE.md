...
1. **משימה אחת בכל פעם** — לא מתחילים משימה הבאה לפני שהנוכחית הושלמה ואומתה
2. **אחרי כל משימה: verify + double-check** — בדיקת קוד תקין + אין שבירה של דברים אחרים — רק אחרי אימות מעבר למשימה הבאה
3. **push אחרי כל 3 משימות** (או פחות אם המשתמש מבקש) — לא commit/push אחרי כל משימה בנפרד, ולא אחרי יותר מ-3
4. **לאחר כל שינוי — חפש תופעות לוואי**: האם יש תנאי guard שנשאר ולא עודכן? האם הפיצ'ר עובד בסולו (בוט) ולא רק מולטיפלייר?
