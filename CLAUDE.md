...
- [ ] מוזיקה נעצרת בהודעת וואטסאפ ולא חוזרת — טיפול ב-AudioInterruption / AudioFocus
- [ ] החלפת סאונד הטיק של הספירה לאחור + סנכרון מדויק עם השניות
- [ ] עיצוב מחדש של ספירת לאחור על המשבצת — יותר מקצועי ומותאם לסגנון האפליקציה
- [ ] אלגוריתם חשיפת משבצות — לא סמוכות זו לזו (דמקה), רק אם אין ברירה אחרת
